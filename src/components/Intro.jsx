...
export default function Intro() {
    return (
        <div className='flex items-center justify-center flex-col text-center pt-20 pb-6'>
            <h1 className='text-4xl sm:text-7xl md:text-7xl mb-1 sm:mb-3 md:mb-3 font-bold drop-shadow-lg transition duration-300 bg-gradient-to-r from-pink-500 to-blue-500 dark:to-orange-500 text-transparent bg-clip-text p-2'>
                Nicholas Ly
            </h1>
            ...
            <p className='text-md max-w-xl mb-6 font-medium drop-shadow-md'>
                ...
                <a className='bg-gradient-to-r from-pink-500 to-blue-500 dark:to-orange-500 text-transparent bg-clip-text'
