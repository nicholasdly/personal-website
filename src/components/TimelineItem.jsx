    ...
    return (
        <ol className='flex flex-col md:flex-row relative border-l border-stone-200 dark:border-stone-700 drop-shadow-sm transition duration-300 group'>
            <li className='mb-10 ml-4'>
                <div className='absolute w-3 h-3 bg-stone-200 rounded-full -left-1.5 mt-1.5 border border-white dark:border-stone-900 dark:bg-stone-700 transition duration-300 group-hover:scale-150' />   
